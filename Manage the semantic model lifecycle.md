...
> ![Workspace de desarrollo vacío](1.%20saleslife%20cycle%20development.png)  
> ![Workspace de producción vacío](2.%20saleslife%20cycle%20production.png)
...
> ![Importación del notebook](3.%20imported%20python%20code%20as%20fabric%20notebook%20.png)
...
> ![Lakehouse creado en el workspace de desarrollo](4.%20created%20lakehouse%20inside%20dev%20workspace.png)
...
> ![Opción para abrir un notebook existente](5.%20open%20a%20notebook%20in%20dev%20workspace%20lakehouse.png)  
> ![Selección del notebook importado](6.%20open%20existing%20notebook.png)
...
> ![Ejecución de la primera celda y refresco de tablas](7.%20once%20first%20code%20line%20is%20runned%20refresh%20tables.png)
...
> ![Tablas creadas y mensaje de confirmación](8.%20tables%20created%20by%20the%20notebook%20code%20.png)

---

**Nota final:** Con estos pasos completé la configuración inicial del entorno, la importación del notebook, la creación del lakehouse y la generación de los datos de muestra. El siguiente paso sería crear el modelo semántico y aplicar la validación con SemPy, pero eso corresponde a la continuación del laboratorio.
